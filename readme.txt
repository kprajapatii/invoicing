...
* Change: Re-use existing invoice when an abandoned checkout session is resumed.
...
* Fix: Reports show db error on multi sites.
...
* Latest Stripe changes compat - ADDED
...
* Confusing email failure message when creating invoices via admin backend - FIXED
...
* Filter to change the default BuddyPress GetPaid tab - ADDED

= 2.5.11 =
* Ability to export subscriptions - ADDED
* Ability to search subscriptions - ADDED
* Updated default tax rates - CHANGED
...
= 2.5.1 =
* Prevent error if Elementor Pro installed and old extension not updated - FIXED
...
= 2.3.4 =
* Payment form CPT editing restricted to admin user role - CHANGED
* Backend payment form labels not fully sanitized for contributor user level and above - FIXED/SECURITY
